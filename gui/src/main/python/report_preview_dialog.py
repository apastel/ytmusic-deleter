...
class DebugReportPreviewDialog(QDialog):
    def __init__(self, logs_json, parent=None):
        ...
        contact_label = QLabel("Optional: Contact info (email or Discord username) for updates:")
        ...
        self.log_viewer.setPlainText(logs_json)
